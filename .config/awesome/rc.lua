...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mywibox:setup {
    ...
    { -- Left widgets
     ...
     -- mylauncher,
      s.mylayoutbox,
      -- wibox.widget.separator({orientation = "vertical"}),
      s.mytaglist,
      s.mypromptbox,
    },
...
awful.spawn.with_shell("nm_applet")
